...
urlpatterns = [ 
    ...
    path('users/<str:user_name>/profile-picture/', views.profilePicture, name='profilePicture'),
    ...
    path('discussions/<int:discussion_id>/comments/<int:discussion_comment_id>/', views.discussionCommentID, 
