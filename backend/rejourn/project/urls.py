...
urlpatterns = [
    ...
    path('users/<str:user_name>/profile-picture/',
            userViews.profilePicture, name='profilePicture'),
    ...
    path('users/<str:user_name>/friends/<str:friend_name>/',
            userViews.userFriendID, name='userFriendID'),

    ## repositoryAPI
    path('repositories/', repositoryViews.repositories, name='repositories'),
    path('repositories/<int:repo_id>/',
            repositoryViews.repositoryID, name='repositoryID'),
    path('repositories/<int:repo_id>/collaborators/',
            repositoryViews.repositoryCollaborators, name='repositoryCollaborators'),
    path('repositories/<int:repo_id>/collaborators/<str:collaborator_name>/',
            repositoryViews.repositoryCollaboratorID, name='repositoryCollaboratorID'),

    ## discussionAPI
    path('repositories/<int:repo_id>/discussions/',
            discussionViews.discussions, name='discussions'),
    path('discussions/<int:discussion_id>/',
            discussionViews.discussionID, name='discussionID'),
    path('discussions/<int:discussion_id>/comments/',
            discussionViews.discussionComments, name='discussionComments'),
    path('discussions/<int:discussion_id>/comments/<int:discussion_comment_id>/',
            discussionViews.discussionCommentID, name='discussionCommentID'),
    ...
    path('posts/<int:post_id>/comments/<int:post_comment_id>/', postViews.postCommentID, name='postCommentID'),
