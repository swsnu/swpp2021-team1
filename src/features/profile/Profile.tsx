...
const exampleImgSrc = 'https://images.unsplash.com/photo-1609866975749-2238afebfa27?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1078&q=80';
...
export default function Profile(props : ProfileProps) {
    ...
    const [account, currentUser, friends, isLoading, hasError] =
        useSelector<RootState, [IUser|null, IDummyUser|null, IDummyUser[], boolean, boolean]>(state =>
        ...
        <div>
            ...
            <div className="row g-0">
                <div className="col-md-4 d-flex align-center">
                    <div id="profile-img">
                        <img src={exampleImgSrc} className="img-fluid" alt="profile-image" />
                    </div>
                ...
                <div className="card-body">
                    ...
                    <p className="card-text mb-0">Dolor anim exercitation sunt amet aute dolor quis fugiat veniam dolore ipsum quis.</p>
                    <ButtonGroup>
