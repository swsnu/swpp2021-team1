...
describe("Photo", () => {
    it("Should display image and can focus image", async () => {
        ...
        const component = mount(
            <Photo photo={photo} onClick={mockFunction} mode={false} focusable checked={false} onCheck={mockCheck} />,
        );
    ...
    it("Should be able to check photos", async () => {
        const photo = photoFactory();
        const component = mount(
            <Photo photo={photo} onClick={mockFunction} mode checked={false} focusable={false} onCheck={mockCheck} />,
        );
