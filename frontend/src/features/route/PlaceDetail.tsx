...
import { IPhoto, IPlace, IRoute } from "../../common/Interfaces";
...
export default function PlaceDetail(props : PlaceDetailProps) {
    const [isLoading, hasError, isQueryLoading, route, queryResult] =
        useSelector<RootState, [boolean, boolean, boolean, IRoute|null, PlaceQueryResult[]]>((state) =>
            [
