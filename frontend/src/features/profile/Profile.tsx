...
import { fetchRepositories } from "../repository/reposSlice";
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            <div className="d-flex align-items-center mb-2">
                                ...
                                <p id="username" className="small text-muted mb-0">@{currentUser ? currentUser.username : "error"}</p>
                            </div>
                            <p className="card-text mb-0">
                                {currentUser ? currentUser.bio : ""}
                            </p>
                            <ButtonGroup>
                                <Button id="num-of-friends" variant="link" onClick={() => setFriendModalShow(true)} className="ms-0 ps-0">{friendList.length} friends</Button>
